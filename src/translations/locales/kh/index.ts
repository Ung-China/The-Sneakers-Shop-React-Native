export const translateKH = {
  ...
  loginSuccess: 'អ្នកបានចូលទៅគណនីរបស់អ្នកដោយជោគជ័យ។',
  loginFailed:
    'ការប៉ុនប៉ងចូលបានបរាជ័យ។ សូមពិនិត្យព័ត៌មានបញ្ចូលរបស់អ្នកហើយសាកល្បងម្តងទៀត។',
  logout: 'ចាកចេញ',
  ...
  checkoutfail: 'មានបញ្ហាមួយក្នុងពេលបង់ប្រាក់។ សូមព្យាយាមម្ដងទៀតនៅពេលក្រោយ។',
  noOrdersHistory: 'មិនមានការបញ្ជាទិញមុនៗទេ។ សូមស្វែងរកផលិតផលរបស់យើង។',
  pending: 'កំពុងរង់ចាំ',
  preparing: 'កំពុងរៀបចំ',
  packed: 'បានខ្ចប់រួចរាល់',
  ...
  delete: 'លុបគណនី',
  deleteDescription:
    'តើអ្នកប្រាកដថាចង់លុបគណនីរបស់អ្នកមែនទេ? បន្ទាប់ពីដំណើរការលុប គ្រប់ទិន្នន័យក្នុងគណនីរបស់អ្នកនឹងត្រូវលុបចោលដោយអចិន្រ្តៃយ៍ ហើយមិនអាចស្ដារឡើងវិញបានទេ។',
